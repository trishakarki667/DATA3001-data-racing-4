...
file_2022 = pd.read_csv('/Users/trishakarki/Desktop/racingdata/f1sim-data-2022.csv')
file_2023 = pd.read_csv('/Users/trishakarki/Desktop/racingdata/f1sim-data-2023.csv')
...
# DROP ROWS WHERE FINISHING TIME IS MISSING, KEEP OTHER ROWS WITH 'NA'
total_data_filtered = total_data_filtered.dropna(subset=['FINISHING_TIME_AT_600'])

# ANY OTHER MISSING VALUES WILL BE FILLED WITH 'NA' WITHOUT DROPPING THE ROWS
total_data_filtered.fillna('NaN', inplace=True)
...
file_left = '/Users/trishakarki/Desktop/racingdata/f1sim-ref-left.csv'
file_right = '/Users/trishakarki/Desktop/racingdata/f1sim-ref-right.csv'
...
data_product_final_file_path = '/Users/trishakarki/Desktop/racingdata/data_product_final.csv'
